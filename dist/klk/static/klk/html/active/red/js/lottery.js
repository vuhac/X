...
$(function () {
    ...
    $.ajax({
        type: 'get',
        url: url+"preferential/grabRedPacket2019",
        headers: {
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                content += '<li><span class="span1">恭喜会员</span> <span class="span2">'+ data[i].name + '</span> <span class="span3">抢到</span><span class="span4">' + data[i].money + '</span> <span class="span5">元红包</span></li>';
            }
...
function queryPage(page) {//page:页数
    $.ajax({
        url: url+"preferential/grabRedPacket2019?type=list&p=" + page + '&size=' + pagesize,
        headers: {
            "Content-Type": "application/x-www-form-urlencoded",
            Authorization: token
        },
