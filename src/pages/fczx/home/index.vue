...
<!--
          ...
          <div class="bd" v-if="hdActive==0">
            <div class="pk10 cqssc">
              <div class="number clearfloat">
                <em
                  :class="'pkActive'+item"
                  :key="index"
                  v-for="(item,index) in allReData[0].lastresultInfoArr"
                >{{item}}</em>
              </div>
            ...
            <div class="bd-text">
              <p>
                <span>
                  当前期：第
                  <i>{{allReData[0].lastissue}}</i>期
                </span>
                <span>
                  开奖号码：
                  <i>{{allReData[0].lastresultInfo}}</i>
                </span>
              </p>
            </div>
          </div>
          ...
          <div class="bd" v-if="hdActive==1">
            <div class="pk10 cqssc">
              <div class="number clearfloat">
                <em
                  :class="'pkActive'+item"
                  :key="index"
                  v-for="(item,index) in allReData[1].lastresultInfoArr"
                >{{item}}</em>
              </div>
            ...
            <div class="bd-text">
              <p>
                <span>
                  当前期：第
                  <i>{{allReData[1].lastissue}}</i>期
                </span>
                <span>
                  开奖号码：
                  <i>{{allReData[1].lastresultInfo}}</i>
                </span>
              </p>
            </div>
          </div>
          ...
          <div class="bd" v-if="hdActive==2">
            <div class="kslhc cqssc">
              <div class="number clearfloat">
                <em
                  ...
                  :key="index"
                  v-for="(item,index) in allReData[2].lastresultInfoArr"
                >{{item}}</em>
              </div>
            ...
            <div class="bd-text">
              <p>
                <span>
                  当前期：第
                  <i>{{allReData[2].lastissue}}</i>期
                </span>
                <span>
                  开奖号码：
                  <i>{{allReData[2].lastresultInfo}}</i>
                </span>
              </p>
            </div>
          </div>
      ...
      <div class="wrapR">
        ...
        <div class="slide">
          ...
          <table>
            <tr>
              <td>
                <img src="../../../../static/fczx/img/home/td1.jpg" alt>
                <p>
                  帐号昵称：
                  <span>逆***</span>
                  <br>昨日奖金：
            ...
            <tr>
              <td>
                <img src="../../../../static/fczx/img/home/slder8.jpg" alt>
                <p>
                  帐号昵称：
                  <span>龙***</span>
                  <br>昨日奖金：
            ...
            <tr>
              <td>
                <img src="../../../../static/fczx/img/home/slder1.jpg" alt>
                <p>
                  帐号昵称：
                  <span>赐***</span>
                  <br>昨日奖金：
    ...
    <div class="home-svg" v-if="svgShow">
      ...
      <embed type="image/svg+xml" src="../../../../static/fczx/img/loading.svg">
    </div>
    <Modal
      :scrollable="true"
      title="网站公告"
    ...
    <!-- <Modal width="657" height="546.67" :scrollable="true" v-model="showimg" class="guanbi">
      <img width="100%" height="100%" src="/static/fczx/img/pcAlert.png">
...
export default {
  data() {
    return {
      imgsrc:"/static/fczx/img/pcAlert.png",
      showimg: false,
      active: 1,
      svgShow: true,
      showPopout: false,
      ...
      wraplCtData1: [
        ...
        },
        {
          ...
          img: "/static/public/image/lottery/nico/png/3631.png",
          sortNmae: "三分快3",
          des: "全天480期",
        ...
        {
          img: "/static/public/image/lottery/nico/png/3630.png",
          sortNmae: "五分赛车",
          des: "全天288期",
      ...
      wraplData: [
        {
          img: "/static/fczx/img/home/vp-9.png",
          sortNmae: "江苏快3",
          des: "全天41期",
          router: "#/plays/tradition/9"
        },
        {
          img: "/static/fczx/img/home/PK10.png",
          sortNmae: "北京赛车",
          des: "全天44期",
          router: "#/plays/tradition/2"
        },
        {
          img: "/static/fczx/img/home/vp-12.png",
          sortNmae: "快速赛车",
          des: "全天1152期",
          router: "#/plays/tradition/12"
        },
        {
          img: "/static/fczx/img/home/vp-13.png",
          sortNmae: "3分赛车",
          des: "3分钟1期",
          router: "#/plays/tradition/13"
        },
        {
          img: "/static/fczx/img/home/vp-4.png",
          sortNmae: "重庆时时彩",
          des: "全天59期",
          router: "#/plays/tradition/4"
        },
        {
          img: "/static/fczx/img/home/vp-16.png",
          sortNmae: "快速时时彩",
          des: "全天1152期",
          router: "#/plays/tradition/16"
        },
        {
          img: "/static/fczx/img/home/vp-17.png",
          sortNmae: "3分时时彩",
          des: "全天480期",
          router: "#/plays/tradition/17"
        },
        {
          img: "/static/fczx/img/home/vp-1.png",
          sortNmae: "香港六合彩",
          des: "一周三期",
          router: "#/plays/tradition/1"
        },
        {
          img: "/static/fczx/img/home/vp-18.png",
          sortNmae: "快速六合彩",
          des: "全天960期",
          router: "#/plays/tradition/18"
        },
        {
          img: "/static/fczx/img/home/vp-19.png",
          sortNmae: "5分六合彩",
          des: "5分钟1期",
          router: "#/plays/tradition/19"
        }
      ...
      wraplCtData: [
        ...
        {
          img: "/static/fczx/img/home/vp-27.png",
          sortNmae: "快速快3",
          des: "全天1152期",
          router: "#/plays/tradition/27"
        },
        {
          img: "/static/public/image/lottery/ico/vp-3分快3.png",
          sortNmae: "三分快3",
          des: "全天480期",
          router: "#/plays/tradition/3631"
        },
        ...
        {
          img: "/static/public/image/lottery/ico/vp-幸运飞艇.png",
          sortNmae: "幸运飞艇",
          des: "全天180期",
          router: "#/plays/tradition/3"
        },
        ...
        {
          img: "/static/public/image/lottery/ico/vp-3分赛车PK10.png",
          sortNmae: "三分赛车",
          des: "全天480期",
          router: "#/plays/tradition/13"
        },
      ...
      random: [
        {
          account: "",
          name: "江苏快3",
          ico: "/static/fczx/img/home/slder1.jpg",
          out: 0
        },
        {
          account: "",
          name: "湖北快3",
          ico: "/static/fczx/img/home/slder.jpg",
          out: 0
        },
        {
          account: "",
          name: "5分六合",
          ico: "/static/fczx/img/home/slder2.jpg",
          out: 0
        },
        {
          account: "",
          name: "极速赛车",
          ico: "/static/fczx/img/home/slder3.jpg",
          out: 0
        },
        {
          account: "",
          name: "北京赛车",
          ico: "/static/fczx/img/home/slder4.jpg",
          out: 0
        },
        {
          account: "",
          name: "快速11选5",
          ico: "/static/fczx/img/home/slder5.jpg",
          out: 0
        },
        {
          account: "",
          name: "幸运飞艇",
          ico: "/static/fczx/img/home/td1.jpg",
          out: 0
        },
        {
          account: "",
          name: "重庆时时彩",
          ico: "/static/fczx/img/home/slder6.jpg",
          out: 0
        },
        {
          account: "",
          name: "幸运农场",
          ico: "/static/fczx/img/home/slder7.jpg",
          out: 0
        },
        {
          account: "",
          name: "广东快乐十分",
          ico: "/static/fczx/img/home/slder8.jpg",
          out: 0
        }
      ],
      scrollDatas: [],
    ...
    .notice {
        ...
        .notice-l {
          ...
          > i.fa {
            ...
            width: 34px;
            height: 25px;
            background: url(/static/fczx/img/noticeIcon.png);
            position: relative;
            top: 7px;
          }
        }
      ...
      .autoTab {
        ...
        .bd {
          .shaizi {
            ...
            span {
              display: inline-block;
              background: url("../../../../static/fczx/img/home/open_num.png");
              width: 60px;
              height: 60px;
