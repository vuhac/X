      ...
      <div class="container">
        ...
        <h3>
          <router-link to="/home" class="router-link-exact-active curr">
            <img src="../../../../static/fczx/img/home/logo2.png">
          </router-link>
        </h3>
  ...
  .w-header {
    ...
    .menu-child1 {
      ...
      *min-height: 564px;
      ...
      .triangles_back {
        ...
        height: 19px;
        position: absolute;
        background: url(/static/fczx/img/triangles_back.png) no-repeat;
        left: 125px;
        top: -8px;
      }
      ...
      .items {
        ...
        .item {
          ...
          .item-ico {
            ...
            color: #222;
            text-align: center;
            background: url(/static/fczx/img/game-icon-bg.png) no-repeat;
            overflow: hidden;
          ...
          &:hover {
            background: url(/static/fczx/img/Wbg_03.png) repeat;
          }
    ...
    .header-top {
      ...
      .snavInfo {
        ...
        .ServiceBtn {
          background: url("/static/fczx/img/home/service.gif");
