<template>
  <div class="wbw-login">
    ...
    <ul class="regMain">
      <li>
        <span>帐 号：</span>
        <input type="text" autocomplete="off" class="userInput" v-model="passKey.userName" @blur="getCode" maxlength="20" placeholder="请输入帐号">

      </li>

      <li>
        <span>密 码：</span>
        <input type="password" autocomplete="off" class="userInput" v-model="passKey.password" v-on:keyup.enter="login" maxlength="20" placeholder="请输入密码">

      </li>
      <li v-if="code_show">
        <span>验 证 码：</span>
        <input type="passwoed" autocomplete="off" class="userInput" v-model="passKey.code" v-on:keyup.enter="login" maxlength="4" placeholder="请输入验证码">
...
<script>
  ...
  export default {
    data () {
      return {
        passKey: {},
        codeImg: '/static/fczx/img/code.jpg',
...
<style lang="less" scoped>
  .wbw-login {
    ...
    padding-top: 20px;
    font-size: 14px;
    background: url("../../../../static/fczx/img/home/loginBg.png") no-repeat 450px 220px #fff;
