    ...
    <ul class="regMain">
      ...
      <li>
        ...
        <input type="text" placeholder="帐号（6-10位数字或字母）" autocomplete="off" class="userInput" v-model="userName"
               @blur="getCode" maxlength="10">
      </li>
      <li>
        <span>密码：</span>
        <input type="password" placeholder="密码（8-20位数字或字母）" autocomplete="off" class="userInput" v-model="password" maxlength="20">
      </li>
  ...
  export default {
    data () {
      return {
        ...
        pulicError: '',
        register: [],
        codeImg: '/static/fczx/img/home/code.jpg',
        captcha_key: '',
        code: '',
        agent: null,
        isCheckbox: true,
