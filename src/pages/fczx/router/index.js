...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/fczx/index.vue')), 'index')
/* const index = () => import('@/pages/fczx/index.vue'); */
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/fczx/home')), 'vpHome')

// const vpHomeLive = r => require.ensure([], () => r(require('@/pages/fczx/home/home-live')), 'vpHomeLive')
// const vpGames = r => require.ensure([], () => r(require('@/pages/fczx/home/games')), 'vpGames')
// const vpBuyu = r => require.ensure([], () => r(require('@/pages/fczx/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/fczx/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/fczx/home/qipai')), 'vpQipai')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/fczx/home/register')), 'register')
const login = r => require.ensure([], () => r(require('@/pages/fczx/home/login')), 'login')
const help = r => require.ensure([], () => r(require('@/pages/fczx/home/help')), 'help')
const moblie = r => require.ensure([], () => r(require('@/pages/fczx/home/moblie')), 'moblie')
const vpCaipiao = r => require.ensure([], () => r(require('@/pages/fczx/home/caipiao')), 'vpCaipiao')
// const vpGoucai = r => require.ensure([], () => r(require('@/pages/fczx/home/goucai')), 'vpGoucai')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/fczx/home/home-contactUs')), 'vpHomeContactUs')
