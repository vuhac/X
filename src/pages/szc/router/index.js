...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/szc/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/szc/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/szc/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/szc/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/szc/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/szc/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const vpQipai = r => require.ensure([], () => r(require('@/pages/szc/home/qipai')), 'vpQipai')
// const register = r => require.ensure([], () => r(require('@/pages/szc/home/register')), 'register')
// const register2 = r => require.ensure([], () => r(require('@/pages/szc/home/register2')), 'register2')
const clause = r => require.ensure([], () => r(require('@/pages/szc/home/clause')), 'clause')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/szc/home/tiyu')), 'vpTiyu')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/szc/home/help/About/index')), 'about')
const contact = r => require.ensure([], () => r(require('@/pages/szc/home/help/contact')), 'contact')
const savings = r => require.ensure([], () => r(require('@/pages/szc/home/help/Savings/index')), 'savings')
const issue = r => require.ensure([], () => r(require('@/pages/szc/home/help/issue')), 'issue')
const partner = r => require.ensure([], () => r(require('@/pages/szc/home/help/partner')), 'partner')
const help_withdrawals = r => require.ensure([], () => r(require('@/pages/szc/home/help/help-Withdrawals')), 'help_withdrawals')
