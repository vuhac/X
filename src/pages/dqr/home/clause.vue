<template>
  <div class="clause">
    <div class="content">
      ...
      <div class="footer">Copyright &copy; 地球人 Reserved</div>
    </div>
  </div>
</template>
<script>
        ...
        <div id="rule_all">
            <div class="width655">
                ...
                <ol>
                    ...
                    <li class="title-style1">地球人拥有对所有游戏规则与条款的修改权和最终解释权。</li>
                </ol>
  ...
  const rule_ipl = {
    template: `<div id="rule_ipl">
                ...
                （b）若牌局未开牌，荷官避开扫描如常开牌后，工务将输入牌之正确数码，并修正不符那张牌的 花色、点数，牌局会如常继续。</li>
                        ...
                        <li class="title-style1">地球人之视讯为真人直播，故该局游戏若因国际线路传输问题出现争议，将以视讯看到牌局结果决定输赢。</li>
                        <li class="title-style1">地球人所提供之牌路仅供参考，若因国际线路问题或其他因素造成牌路显示有误，所有游戏结果将以视讯开牌及游戏纪录为主。</li>
                        <li class="title-style1">本公司保留一切有争议事项的修正及最后的决策。</li>
                        <li class="title-style1">地球人保留随时更改、修订或删除游戏、游戏规则（包括机率及赔率）及协议条款的权利而无须作事先通知。</li>
                        <li class="title-style1">地球人保留随时修订、撤销或中止任何投注的权利而无须作事先通知，亦无须作任何解释。</li>
                        <li class="title-style1">地球人纪录每一项于本网站伺服器内执行的交易及投注功能。若会员认为向本娱乐城提供的资料与本网站资料库中的资料纪录之间出现了任何声称的差异，一切均以本网站资料库的资料为准。</li>
                        <li class="title-style1">当会员已于地球人之游戏厅内下注，而电脑出现连线异常导致牌局中断时，会员最后押住仍视为有效，本娱乐城将以会员于本网站资料库的交易纪录为准。</li>
