      ...
      <div class="content">
        ...
        <div class="row">
          ...
          <div class="group">
            ...
            <input type="text" placeholder="请输入6到20位的数字或字母组合" maxlength="20" v-model="userName" @blur="getCode">
          </div>
        </div>
...
<script>
  ...
  export default {
    data () {
      return {
        register: [],
        codeImg: '/static/ly88/img/code.jpg',
        captcha_key: '',
        userName: '',
        password: '',
        register_password: '',
    ...
    methods: {
      ...
      close () {
        this.$store.commit('ly88/showRegister', false)
      }
    },
    computed: {
      isResiter () {
        // return this.$store.state.ly88.registerShow
      }
    },
    store
  }
  ...
  .register {
    ...
    .popup {
      ...
      .headline {
        ...
        background: url("/static/ly88/img/bg_reg_title.png");
