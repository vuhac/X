    ...
    data () {
      return {
        buyuData: [
          {
            name: '皇冠体育',
            img: '/static/ly88/img/sport/bg_sports_01.png',
            content: '简单操作，自由编排',
            platform: 'sport',
            gameName: '21',
            id:39
          ...
          {
            name: 'BBIN体育',
            img: '/static/ly88/img/sport/bg_sports_02.png',
            content: '全新竞技 多种体验',
            platform: 'sport',
            gameName: '41',
            id:41
          ...
          {
            name: 'AG体育',
            img: '/static/ly88/img/sport/bg_sports_03.png',
            content: '经典玩法 玩法丰富',
            platform: 'sport',
            gameName: '22',
            id:40
          ...
          {
            name: '沙巴体育',
            img: '/static/ly88/img/sport/bg_sports_04.png',
            content: '各式赔率，一触即发',
            platform: 'sport',
            gameName: '20',
            id:38
...
<style lang="less" scoped>
  .sports_main {
    ...
    height: 900px;
    background: url("/static/ly88/img/sport/bg_sports.jpg") center top;
      ...
      ul {
        li {
          ...
          .cover {
            width: 100%;
            height: 390px;
            // background: url("/static/ly88/img/sport/bg_fish_01.png") center
            //   center no-repeat;
