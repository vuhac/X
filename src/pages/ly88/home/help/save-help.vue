...
<script>
  export default {
    ...
    <p>
        ...
        如入款帐号已过期，大众娱乐 恕不负责！万请见谅，感谢配合。<br>
        <br>
        4. 核对提交数据/提交申请<br>
    ...
    <p>
        ...
        2. 选择入款额度，并请确实填写 ”联络电话” ，如有任何问题，方便大众娱乐 客服第一时间与您联系。<br>
        3. 选择”支付银行”。<br>
        ...
        5. 进入网络银行页面，请确实填写您银行帐号信息，支付成功，额度将在10分钟内系统处理完成，立即加入您的大众娱乐 会员帐号。<br>
        <br>
        存款需知:<br>
        大众娱乐 最低存款为$100人民币，最高存款无上限!<br>
