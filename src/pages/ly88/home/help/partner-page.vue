<template>
  <div class="body">
    ...
    <div class="content" v-show="index === 0">
      <p>
        大众娱乐 ，与AG进行技术合作，拥有菲律宾合法注册之博彩公司。拥有多元化的产品，使用最公平、公正、公开的系统，在市场上的众多博彩网站中，我们自豪的提供会员最优惠的回
        馈，给予合作伙伴最优势的营利回报! 无论您拥有的是网络资源，或是人脉资源，都欢迎您来加入大众娱乐 合作伙伴的行列，无须负担任何费用，就可以开始无上限的收入。大众娱乐 ，绝对是您最聪明的选择!</p>
      <p>
        ?注册申请<br>
        ...
        更改银行帐号的,必须提前一个星期联系在线客服进行修改，否则本公司一律不负责。大众娱乐 会评估审核联盟申请讯息，3日内由专员与您联系开通，并提供您的注册帐号、密码及推广链接。</p>
      ...
      <p>
        ...
        <span style="color: #ff0000;">●相应费用包括：会员各项优惠、存/取款相应手续费(请留意：大众娱乐 会员重复出款￥手续费/未达100%投注出款的手续费由会员吸收，不纳入计算)。</span><br>
    ...
    <div class="content" v-show="index === 1">
      ...
      <p>
        <strong>一、大众娱乐 对代理联盟的权利与义务</strong></p>
      <ol>
        <li align="left">大众娱乐 的客服部会登记联盟的会员并会观察他们的投注状况。联盟及会员必须同意并遵守大众娱乐 的会员条例，政策及操作程序。大众娱乐 保留拒绝或冻结联盟/会员帐号权利</li>
        <li align="left">代理联盟可随时登入接口观察旗下会员的下注状况及会员在网站的活动概况。 大众娱乐 的客服部会根据代理联盟旗下的会员计算所得的佣金。</li>
        <li align="left">大众娱乐 保留可以修改合约书上的任何条例，包括: 现有的佣金范围、佣金计划、付款程序、及参考计划条例的权力，大众娱乐 会以电邮、网站公告等方法通知代理联盟。
          代理联盟对于所做的修改有异议，代理联盟可选择终止合约，或洽客服人员反映意见。 如修改后代理联盟无任何异议，便视作默认合约修改，代理联盟必须遵守更改后的相关规定。
        </li>
      </ol>
      <p align="left">
        <strong>二、代理联盟对大众娱乐 的权力及义务</strong></p>
      <ol>
        <li align="left">
          代理联盟应尽其所能，广泛地宣传、销售及推广大众娱乐 ，使代理本身及大众娱乐 的利润最大化。代理联盟可在不违反法律下，以正面形象宣传、销售及推广大众娱乐 ，并有责任义务告知旗下会员所有大众娱乐 的相关优惠条件及产品。
        </li>
        <li align="left">代理联盟选择的大众娱乐 推广手法若需付费，则代理应承担该费用。</li>
        <li align="left">任何大众娱乐 相关信息包括: 标志、报表、游戏画面、图样、文案等，代理联盟不得私自复制、公开、分发有关材料，大众娱乐 保留法律追诉权。
          如代理在做业务推广有相关需要，请随时洽大众娱乐 。
        </li>
      </ol>
      <p align="left">
      ...
      <ol>
        <li align="left">
          各阶层代理联盟不可在未经大众娱乐 许可情况下开设双/多个的代理帐号，也不可从大众娱乐 人帐号或相关人士赚取佣金。请谨记任何阶层代理不能用代理帐号下注，大众娱乐 有权终止并封存帐号及所有在游戏中赚取的佣金。
        </li>
        <li align="left">
          为确保所有大众娱乐 会员帐号隐私与权益，大众娱乐 不会提供任何会员密码，或会员个人资料。各阶层代理联盟亦不得以任何方式取得会员数据，或任意登入下层会员帐号，如发现代理联盟有侵害大众娱乐 会员隐私行为，大众娱乐 有权取消代理联盟红利，并取消代理联盟帐号。
        </li>
        <li align="left">
          代理联盟旗下的会员不得开设多于一个的帐号。大众娱乐 有权要求会员提供有效的身份证明以验证会员的身份，并保留以IP判定是否重复会员的权利。如违反上述事项，大众娱乐 有权终止玩家进行游戏并封存帐号及所有于游戏中赚取的佣金
        </li>
        <li align="left">代理联盟不可为自己或其他联盟下的有效投注会员,只能是公司直属下的有效投注会员,
          代理每月需有5个下线有效投注（有效投注为每周至少上线3次进行正常投注），如有违反联盟协议大众娱乐 有权终止并封存帐号及所有在游戏中赚取的佣金。
        </li>
        <li align="left">
          如代理联盟旗下的会员因为违反条例而被禁止享用大众娱乐 的游戏，或大众娱乐 退回存款给会员，大众娱乐 人将不会分配相应的佣金给代理联盟。如代理联盟旗下会员存款用的信用卡、银行资料须经审核，大众娱乐 保留相关佣金直至审核完成。
        </li>
        <li align="left">合约内的条件会以大众娱乐 通知接受代理联盟加入后开始执行。大众娱乐 及代理联盟可随时终止此合约，在任何情况下，代理联盟如果想终止合约，都必须以书面/电邮方式提早于七日内通知大众娱乐 。
          代理联盟的表现会3个月审核一次，如代理联盟已不是现有的合作成员则本合约书可以在任何时间终止。如合作伙伴违反合约条例，大众娱乐 有权立即终止合约。
        </li>
        <li align="left">在没有大众娱乐 许可下，代理联盟不能透露及授权大众娱乐 相关密数据，包括代理联盟所获得的回馈、佣金报表、计算等;代理联盟有义务在合约终止后仍执行机密文件及数据的保密。</li>
        <li align="left">在合约终止后，代理联盟及大众娱乐 将不须要履行双方的权利及义务。终止合约并不会解除代理联盟于终止合约前应履行的义务。</li>
      </ol>
    </div>
  </div>
</template>
