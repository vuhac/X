...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/ly88/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/ly88/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/ly88/home/home-live')), 'vpHomeLive')
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/ly88/home/home-contactUs')), 'vpHomeContactUs')
const vpGames = r => require.ensure([], () => r(require('@/pages/ly88/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/ly88/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/ly88/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/ly88/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/ly88/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const clause = r => require.ensure([], () => r(require('@/pages/ly88/home/clause')), 'clause')
...
// const register = r => require.ensure([], () => r(require('@/pages/ly88/home/register')), 'register')
// 加盟
const agent = r => require.ensure([], () => r(require('@/pages/ly88/home/agent')), 'agent')

const vpAboutPage = r => require.ensure([], () => r(require('@/pages/ly88/home/help/about-page')), 'vpAboutPage')
const vpIssue = r => require.ensure([], () => r(require('@/pages/ly88/home/issue')), 'vpIssue')
const vpDuty = r => require.ensure([], () => r(require('@/pages/ly88/home/duty')), 'vpDuty')
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/ly88/home/help/save-help')), 'vpSaveHelp')
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/ly88/home/help/pull-help')), 'vpPullHelp')
const vpRelation = r => require.ensure([], () => r(require('@/pages/ly88/home/help/relation')), 'vpRelation')
