<template>
  <div>
    <div class="vp-ly88-style" :class="{'tcgBlur':$store.state.personal.isPersonal}">
      <!-- 传统彩票 -->
      ...
      <!-- 主页 -->
      <div v-else class="ly88-cont-wrap">
  ...
  export default {
    data () {
      return {
        ...
        lotHeadDatas: {
          logoUrl: '/static/ly88/img/gc.png',
          downLoadurl: '/static/ly88/html/download/index.html'
        }
      }
    },
    methods: {
