...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/csdf/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/csdf/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/csdf/home/home-live')), 'vpHomeLive')
// const vpRegister = r => require.ensure([], () => r(require('@/pages/csdf/home/register')), 'vpRegister')
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/csdf/home/home-contactUs')), 'vpHomeContactUs')
const vpGames = r => require.ensure([], () => r(require('@/pages/csdf/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/csdf/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/csdf/home/youhui/index1')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/csdf/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/csdf/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const vpIssue = r => require.ensure([], () => r(require('@/pages/csdf/home/issue')), 'vpIssue')
const vpDuty = r => require.ensure([], () => r(require('@/pages/csdf/home/duty')), 'vpDuty')
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/csdf/home/help/save-help')), 'vpSaveHelp')
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/csdf/home/help/pull-help')), 'vpPullHelp')
const vpRelation = r => require.ensure([], () => r(require('@/pages/csdf/home/help/relation')), 'vpRelation')
const vpAboutPage = r => require.ensure([], () => r(require('@/pages/csdf/home/help/about-page')), 'vpAboutPage')
const vpPartnerPage = r => require.ensure([], () => r(require('@/pages/csdf/home/help/partner-page')), 'vpPartnerPage')
const clause = r => require.ensure([], () => r(require('@/pages/csdf/home/clause')), 'clause')
const agent = r => require.ensure([], () => r(require('@/pages/csdf/home/agent')), 'agent')
