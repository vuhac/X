<template>
  <div class="footer-main">
    <ul class="footer-child footer-nav clear-fix">
      <li class="nav-item">
        <div
          style="width: 202px;height: 47px;background: url('/static/csdf/img/bottom_wy.png') no-repeat 0 0;background-size: 202px 47px;"></div>
        <div class="head-foot"
      ...
      <li class="nav-item">
        ...
        <ol>
          ...
          <li><a href="#/home/relation" target="_blank">联系我们</a></li> -->
           <li v-for="(item,i) in goinfo2" :key="i"><a @click="goLink(item.link)">{{item.name}}</a></li>
        </ol>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <ol>
          ...
          <li><a href="/m">手机投注</a></li> -->
           <li v-for="(item,i) in goinfo3" :key="i"><a @click="goLink(item.link)">{{item.name}}</a></li>
        </ol>
      </li>
    </ul>
    ...
    <div class="footer-child other">
      賽馬會 版权所有 ©2008-2020
      <br/>
      賽馬會 提醒您：理性购彩，热心公益。未满18周岁的未成年人禁止购彩及兑奖！
    </div>
    ...
    data(){
       return{
         goinfo:[
          ...
          { name:'责任博彩', link:'/home/duty'},
         ],
         goinfo2:[
          { name:'存款帮助',link:'/home/save-help' },
          { name:'取款帮助', link:'/home/pull-help'},
          { name:'联系我们', link:'/home/relation'},
         ],
         goinfo3:[
          { name:'关于我们',link:'/home/about-page' },
          { name:'合作伙伴', link:'/home/partner-page'},
          { name:'手机版下载', link:'/static/csdf/html/download/index.html'},
         ],
       }
    },
    methods: {
      ...
      goto(item,index){
       ...
       goLink (link) {
          if(link=='/static/csdf/html/download/index.html'){
              window.open(link)
          }else{
  ...
  .footer-main {
    ...
    .footer-nav {
      ...
      .nav-item {
        ...
        .head-foot {
          background: url("/static/csdf/img/headfoot.png") no-repeat;
        }
    ...
    .images {
      ...
      .footer-img {
        ...
        margin: 0 10px;
        float: left;
        background: url("/static/csdf/img/footer_img.png") no-repeat;
      }
    }
