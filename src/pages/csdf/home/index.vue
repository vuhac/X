      ...
      <div class="body">
                    ...
                    <div class="content-main">
                      ...
                      <div class="action">
                        <!-- <div class="content_bottom">
                            <span>距离下次投注时间还有:</span>
                            <GameTimer :timerDatas='recommendList'></GameTimer>
                        </div> -->
        ...
        <div class="right">
          ...
          <div class="center">
            ...
            <div class="down-box">
              <div class="down-title">賽馬會 客户端</div>
          ...
          <img class="down" src="/static/csdf/img/gounian.png"/>
        </div>
      </div>
    </div>
  ...
  export default {
    ...
    data () {
      return {
        ...
        lanternWidth: '0',
        carouselData: [],
        downLoadurl:"/static/csdf/html/download/index.html",
        navData1: [
           {
            name: '快速赛车PK10',
            doc: '高频彩 易中奖',
        ...
        tabData: [
          ...
          },
          {
            ...
            path: '/home/live',
            list: [
              {name: 'AG视讯厅', platform: 'live_casino', id: '14', icon: '/static/csdf/img/live/icon/AG_LIVE.png'},
              {name: 'BBIN视讯厅', platform: 'live_casino', id: '15', icon: '/static/csdf/img/live/icon/BBIN_LIVE.png'},
              {name: 'BG视讯厅', platform: 'live_casino', id: '44', icon: '/static/csdf/img/live/icon/BG_LIVE.png'},
              {name: 'DG视讯厅', platform: 'live_casino', id: '33', icon: '/static/csdf/img/live/icon/DG_LIVE.png'},
              {name: 'DS视讯厅', platform: 'live_casino', id: '16', icon: '/static/csdf/img/live/icon/DS_LIVE.png'},
              {name: 'LEBO视讯厅', platform: 'live_casino', id: '35', icon: '/static/csdf/img/live/icon/LEBO_LIVE.png'},
              {name: 'OG视讯厅', platform: 'live_casino', id: '39', icon: '/static/csdf/img/live/icon/OG_LIVE.png'},
              {name: 'eBET视讯厅', platform: 'live_casino', id: '34', icon: '/static/csdf/img/live/icon/EBET_LIVE.png'},
              {name: 'LMG视讯厅', platform: 'live_casino', id: '36', icon: '/static/csdf/img/live/icon/LMG_LIVE.png'},
              {name: '欧博视讯厅', platform: 'live_casino', id: '37', icon: '/static/csdf/img/live/icon/AB_LIVE.png'},
              {name: 'SA视讯厅', platform: 'live_casino', id: '40', icon: '/static/csdf/img/live/icon/SA_LIVE.png'}
            ]
          }
        ],
        tabIndex: 0,
        ...
        if (item) {
          this.$http.get(`${this.$HOST_NAME}/lottery/getIssue/${item.id}`).then(
            res => {
              ...
              item.result = {
                lastissue: (res.data.lastissue).toString().length>8 ? (res.data.lastissue).toString().slice(4) : res.data.lastissue,
      ...
      goto(id){
         if(localStorage.token){
            if(localStorage.Public_User=='test' ){
              ...
              // this.$router.push(id)
              let routeData = this.$router.resolve({ path: id});
...
<style type="text/less" lang="less" scoped>
  ...
  .main {
    background: url(/static/csdf/img/bg-article.png) #fff no-repeat center 96px;
    padding-bottom: 10px;
