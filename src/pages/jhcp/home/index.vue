<template>
  <div class="new-home">
          ...
          <!-- <div class="appCode fr">
            ...
            <div class="wrapper">
              <div v-show="isCode=='ios'" class="ios">
                <img src="/static/jhcp/img/ios.png" alt="">
              </div>
              <div v-show="isCode=='android'" class="android">
                <img src="/static/jhcp/img/android.png" alt="">
              </div>
            </div>
          </div> -->
        </div>
        <div class="news">
          <div class="newsContent">
            <div class="demolist list" style="height:35px;">
              <div class="notice">
                <img src="/static/jhcp/img/icon_notice.png" alt="">
              </div>
    ...
    <Modal :scrollable=true title="网站公告" ok-text="关闭" v-model="showPopout" width="657" class="vp-popout-box">
      ...
      <Modal width="657" height="546.67" :scrollable=true v-model="showimg" class='guanbi'><img width="100%" height="100%" src="/static/jhcp/img/pcAlert.png"/><span class="close" @click="close"></span></Modal>
  </div>
</template>
    ...
    data () {
      return {
        ...
        lives: [
          {
            name: '购彩大厅',
            src: '/static/jhcp/img/nhome/game2.png',
            // id: 14,
            path:"/plays/hall",
          ...
          {
            name: '棋牌游戏',
            src: '/static/jhcp/img/nhome/game3.png',
            path:"/home/qipai",
            // id: 15,
            // platform: 'live_casino'
          },
          ...
          {
            name: '捕鱼达人',
            src: '/static/jhcp/img/nhome/game1.png',
            path:"/home/buyu",
            // id: 16,
            // platform: 'live_casino'
          }
...
<style lang="less" scoped>
  ...
  .new-home {
    padding-bottom: 10px;
    background-image: url(/static/jhcp/img/home_bj.png);
    ...
    .container {
      ...
      .wrapR {
          ...
          .right {
            ...
            .img {
              ...
              i {
                ...
                background: url(/static/jhcp/img/icon/home.fw.png) no-repeat -142px
                6px;
              }
            ...
            .rule {
              ...
              i {
                ...
                width: 32px;
                height: 32px;
                background: url(/static/jhcp/img/icon/home.fw.png) no-repeat;
                line-height: 32px;
                color: #cc0000;
                vertical-align: middle;
              }
        ...
        .lives {
          ...
          margin-top: 10px;
          // padding: 11px 0;
          background: url(/static/jhcp/img/livebg.png) repeat;
          ...
          .wrapper {
            ...
            .liveItem {
              ...
              span {
                ...
                padding: 13px 58px;
                display: none;
                background: url(/static/jhcp/img/livebtn-enter.png) no-repeat;
              }
