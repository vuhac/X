...
const help = r => require.ensure([], () => r(require('@/pages/jhcp/home/help/index.vue')), 'help')
const question = r => require.ensure([], () => r(require('@/pages/jhcp/home/help/question.vue')), 'question')
const vpQipai = r => require.ensure([], () => r(require('@/pages/jhcp/home/qipai')), 'vpQipai')
const vpSport = r => require.ensure([], () => r(require('@/pages/jhcp/home/sport')), 'vpSport')
const contactUs = r => require.ensure([], () => r(require('@/pages/jhcp/home/contactUs')), 'contactUs')
const clause = r => require.ensure([], () => r(require('@/pages/jhcp/home/clause')), 'clause')
