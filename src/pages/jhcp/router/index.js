...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/jhcp/index.vue')), 'index')
/* const index = () => import('@/pages/jhcp/index.vue'); */
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/jhcp/home')), 'vpHome')

// const vpHomeLive = r => require.ensure([], () => r(require('@/pages/jhcp/home/home-live')), 'vpHomeLive')
// const vpGames = r => require.ensure([], () => r(require('@/pages/jhcp/home/games')), 'vpGames')
// const vpBuyu = r => require.ensure([], () => r(require('@/pages/jhcp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/jhcp/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/jhcp/home/qipai')), 'vpQipai')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/jhcp/home/register')), 'register')
const login = r => require.ensure([], () => r(require('@/pages/jhcp/home/login')), 'login')
const help = r => require.ensure([], () => r(require('@/pages/jhcp/home/help')), 'help')
const moblie = r => require.ensure([], () => r(require('@/pages/jhcp/home/moblie')), 'moblie')
const vpCaipiao = r => require.ensure([], () => r(require('@/pages/jhcp/home/caipiao')), 'vpCaipiao')
// const vpGoucai = r => require.ensure([], () => r(require('@/pages/jhcp/home/goucai')), 'vpGoucai')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/jhcp/home/home-contactUs')), 'vpHomeContactUs')
