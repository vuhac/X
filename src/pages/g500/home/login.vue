<template>
  <div class="wbw-login">
    ...
    <ul class="regMain">
      ...
      <li>
        <span>密 码：</span>
        <input type="password" autocomplete="off" class="userInput" v-model="passKey.password" v-on:keyup.enter="login">

      </li>
      <li v-if="code_show">
        <span>验 证 码：</span>
        <input type="passwoed" autocomplete="off" class="userInput" v-model="passKey.code" v-on:keyup.enter="login">
