...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/g500/index.vue')), 'index')
/* const index = () => import('@/pages/g500/index.vue'); */
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/g500/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/g500/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/g500/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/g500/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/g500/home/youhui')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/g500/home/qipai')), 'vpQipai')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/g500/home/register')), 'register')
const login = r => require.ensure([], () => r(require('@/pages/g500/home/login')), 'login')
const help = r => require.ensure([], () => r(require('@/pages/g500/home/help')), 'help')
const moblie = r => require.ensure([], () => r(require('@/pages/g500/home/moblie')), 'moblie')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/g500/home/home-contactUs')), 'vpHomeContactUs')
