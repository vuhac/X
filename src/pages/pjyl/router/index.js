...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/pjyl/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/pjyl/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/pjyl/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/pjyl/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/pjyl/home/buyu')), 'vpBuyu')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/pjyl/home/tiyu')), 'vpTiyu')

const vpYouhui = r => require.ensure([], () => r(require('@/pages/pjyl/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/pjyl/home/register')), 'register')
const vpQipai = r => require.ensure([], () => r(require('@/pages/pjyl/home/qipai')), 'vpQipai')
// const register2 = r => require.ensure([], () => r(require('@/pages/pjyl/home/register2')), 'register2')
const clause = r => require.ensure([], () => r(require('@/pages/pjyl/home/clause')), 'clause')
const agent = r => require.ensure([], () => r(require('@/pages/pjyl/home/agent')), 'agent')
// 帮助
// const about = r => require.ensure([], () => r(require('@/pages/pjyl/home/help/About/index')), 'about')
// const contact = r => require.ensure([], () => r(require('@/pages/pjyl/home/help/contact')), 'contact')
// const savings = r => require.ensure([], () => r(require('@/pages/pjyl/home/help/Savings/index')), 'savings')
// const issue = r => require.ensure([], () => r(require('@/pages/pjyl/home/help/issue')), 'issue')
// const partner = r => require.ensure([], () => r(require('@/pages/pjyl/home/help/partner')), 'partner')
// const help_withdrawals = r => require.ensure([], () => r(require('@/pages/pjyl/home/help/help-Withdrawals')), 'help_withdrawals')
