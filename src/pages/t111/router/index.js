...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/t111/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/t111/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/t111/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/t111/home/games')), 'vpGames')
const vpQipai = r => require.ensure([], () => r(require('@/pages/t111/home/qipai')), 'vpQipai')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/t111/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/t111/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/t111/home/register')), 'register')
// const register2 = r => require.ensure([], () => r(require('@/pages/t111/home/register2')), 'register2')
const clause = r => require.ensure([], () => r(require('@/pages/t111/home/clause')), 'clause')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/t111/home/help/About/index')), 'about')
const contact = r => require.ensure([], () => r(require('@/pages/t111/home/help/contact')), 'contact')
const savings = r => require.ensure([], () => r(require('@/pages/t111/home/help/Savings/index')), 'savings')
const issue = r => require.ensure([], () => r(require('@/pages/t111/home/help/issue')), 'issue')
const partner = r => require.ensure([], () => r(require('@/pages/t111/home/help/partner')), 'partner')
const help_withdrawals = r => require.ensure([], () => r(require('@/pages/t111/home/help/help-Withdrawals')), 'help_withdrawals')
...
//体育
const vp_tiyu = r => require.ensure([], () => r(require('@/pages/t111/home/tiyu/index')), 'tiyu')
const vp_caipiao = r => require.ensure([], () => r(require('@/pages/t111/home/caipiao/index')), 'caipiao')
