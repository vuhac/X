  ...
  export default {
    data () {
      return {
        ...
        showmodle:false,
        passKey: {},
        codeImg: '/static/t111/img/thirdparty/code.jpg',
        dengjiImg: '/static/t111/img/thirdparty/vip-sprites.png',
        left: 5,
        top: -193,
        showReload: false,
    ...
    methods: {
      ...
      goHeader(typeNum){
        if(typeNum==0){
          ...
          // 金管家
          window.open("/static/t111/html/active/sxjgj/index.html","_blank");
        }
      },
            //获取时间
      ee(num) {
