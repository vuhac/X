...
<div>
  ...
  <!-- <div class="new2019 animated fadeInUp mobile_auto" onclick="window.open('/static/t111/html/active/pig2019/#')" v-if="showNew2019">
...
<style lang="less" scoped>
  .qy-service {
    ...
    li:hover {
      background: url("/static/t111/img/thirdparty/service-bg.png");
      border: unset;
    }

    .service {
      div{
        background: url("/static/t111/img/thirdparty/kefu.png");
      }
    }
    .by-service{
      div{
        background:url(/static/t111/img/thirdparty/by-kefu.png)
      }
    }

    .cs-mail {
      div{
        background: url("/static/t111/img/thirdparty/tousu.png");
      }
      .shrink {
        right: 70px;
        background: #fff;
    ...
    .Agency{
      div{
         background:url(/static/t111/img/thirdparty/daili.png)
      }
    }
    // .jiebei {
    //   div{
    //     background: url("/static/t111/img/thirdparty/jiebei.png");
    //   }
    // }

    // .gold_housekeeper {
    //   div{
    //     background: url("/static/t111/img/thirdparty/jinguanjia.png");
    //   }
    // }

    .download{
      div{
        background: url("/static/t111/img/thirdparty/download.png")
      }
    }

    .cs-goTop {
      div{
        background: url("/static/t111/img/thirdparty/zhiding.png")
      }
    }
  }
  .new2019{
    ...
    width: 230px;
    height: 230px;
    background-image: url('/static/t111/img/new2019.gif');

    .clBtn{
      background: url('/static/t111/img/new2019_close.png'); 
      z-index: 99999; 
      position: absolute; 
      width: 23px;
      height: 23px; 
