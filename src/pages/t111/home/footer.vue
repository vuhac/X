    ...
    <div class="footer">
        <div class="footer-detail" :style="{background: 'url(' + footerBg + ')  no-repeat center top'}" :class="{night:colorbool}">
            <div class="foot_links">
                <ul class="wp flex">
                    ...
                    <li class="support-browser-cont">
                        ...
                        <div>
                            <img src="/static/t111/img/home/image_2019_02_14T08_53_01_247Z.png" alt="" width="100">
                        </div>
                    </li>
                    <li class="regulatory-authority">
                        <h3 class="footer-link-title">监管机构</h3>
                        <div>
                            <img src="/static/t111/img/home/image_2019_02_14T08_52_29_378Z.png" alt="" width="60">
                        </div>
                    </li>
                    <li class="platform-cont">
                        <h3 class="footer-link-title">合作伙伴</h3>
                        <div>
                            <img src="/static/t111/img/image_2019_02_14T07_35_30_910Z.png" alt="" width="100%">
                        </div>
                    </li>
                </ul>
            </div>
            <div class="copyright">
                <div class="wp">
                    <div>
                        <!-- 千赢国际持有菲律宾 PAGCOR合法博彩执照&nbsp;&nbsp;版权为千赢国际所有&nbsp;&nbsp;PT游戏是由PT TransPacific在的授权下部署&nbsp;<img src="/static/t111/img/pagcor_xs.png"> -->
                        版权为澳门新葡京 所有 © 2019
                    </div>
                </div>
            </div>
  ...
  export default {
    data () {
      return {
        ...
        footerBg:"/static/t111/img/home/image_2019_02_14T08_56_54_932Z.png"
      }
    },
    methods: {
      goHelp (link) {
    ...
    watch:{
       colorbool(newbool,oldbool){
          if(newbool==true){
            this.footerBg ='/static/t111/img/index-main-bg-n.jpg'
          }else{
            this.footerBg = "/static/t111/img/home/image_2019_02_14T08_56_54_932Z.png"
          }
       },
      // '$route.path': function (newVal, oldVal) {
      //     this.$store.commit('mainState/getRoute',newVal)
      //     if(newVal === "/home/live"){
      //       this.footerBg = "/static/t111/img/live/image_2019_02_18T01_13_08_099Z.png"
      //     }
      //     else if(newVal === "/home/buyu"){
      //       this.footerBg = "/static/t111/img/buyu/footer-bg.jpg"
      //     }
      //     else if(newVal ==='/home/tiyu' ){
      //       this.footerBg = '/static/t111/img/home/footer-bg.png'
      //     }
      //     else if(newVal ==='/home/games' ){
      //       this.footerBg = '/static/t111/img/home/lhjfooter-bg.jpg'
      //     }
      //     else if(newVal == '/home/qipai'){
      //       this.footerBg = '/static/t111/img/home/qpfooter-bg.jpg'
      //     }
      //     else if(newVal == '/home/youhui'){
      //       this.footerBg = '/static/t111/img/home/yhfooter-bg.jpg'
      //     }
      //     else{
      //       this.footerBg = "/static/t111/img/home/image_2019_02_14T08_56_54_932Z.png"
      //     }
