<template>
  ...
  <div class="content">
    <div class="register-logo">
      <!-- <img src="/static/t111/img/thirdparty/regbanner.jpg" alt=""> -->
        免费注册
    </div>
    ...
    <div class="content clearfloat">
      <div class="left fl">
             <img class="phone-img1 animated fadeInLeft" src="/static/t111/img/thirdparty/pone-bg.png" alt="">
...
<style lang="less" scoped>
  .register {
    ...
    .register-logo{
        ...
        font-size: 36px;
        color: #fc49af;
        background: url(/static/t111/img/thirdparty/regbanner.jpg) no-repeat center;
        }
    .reg_step {
       text-align: center;
       margin: 0 auto 50px;
      ...
      ul {
        ...
        .active {
          background: url(/static/t111/img/thirdparty/hover.png) no-repeat center;
          .tip-num{
             background: #9968fd;
          }
        }
    ...
    .content {
      ...
      .left {
       ...
       width: 461px;
       height: 486px;
       background: url(/static/t111/img/thirdparty/left_banner.png) no-repeat center;
       ...
       .phone-img1 {
         ...
         .qy-code-down1 {
            ...
            width: 213px;
            height: 249px;
            background:url('/static/t111/img/thirdparty/qy-code-down.png') no-repeat;
            .qr-code{
               margin-top: 80px;
               margin-left: 45px;
            }
      ...
      .list-box {
        .text-context {
            ...
            .iconfont {
             ...
             .yonghu{
                background:url('/static/t111/img/zhuce/username.png') no-repeat;
                background-size:100% 100%;
              }
             .mima{
                background:url('/static/t111/img/zhuce/mimaask.png') no-repeat;
                background-size:100% 100%;
              }
             .yanzhengma{
                background:url('/static/t111/img/zhuce/yanzhengma.png') no-repeat;
                background-size:100% 100%;
              }
              .shoujihao{
                background:url('/static/t111/img/zhuce/shoujihao.png') no-repeat;
                background-size:100% 100%;
              }
               .yaoqingma{
                background:url('/static/t111/img/zhuce/yaoqingma.png') no-repeat;
                background-size:100% 100%;
              }
               .youxiang{
                background:url('/static/t111/img/zhuce/youxiang.png') no-repeat;
                background-size:100% 100%;
              }
               .weixin{
                background:url('/static/t111/img/zhuce/weixin.png') no-repeat;
                background-size:100% 100%;
              }
               .zhifumima{
                  background:url('/static/t111/img/zhuce/zhifumima.png') no-repeat;
                  background-size:100% 100%;
               }
              input{
                position: relative;
