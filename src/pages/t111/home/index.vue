          ...
          <div class="game-lists-container">
            <ul class="above-game-content" >
               ...
               <li class="live-sport-cont">
                 <ul>
                   <li class="live-game slideRight1 t-default t1" @click="$router.push({path:'/home/qipai?id=42&name=开元棋牌'})" >
                       <a href="javascript:void(0)" target="_blank">
  ...
  export default {
    ...
    data () {
      return {
        ...
        showPopout: false,
        nightColor:"#fff",
        imgsrc:'/static/t111/img/pcAlert.png',
        imgdata:['/static/t111/img/pcAlert1.png','/static/t111/img/pcAlert2.png','/static/t111/img/pcAlert3.png'],
        popups: '',
        lantern: '',
        value3: 0,
        // 轮播设置
        ...
        displayDatas:{
          fristData:[
            {
              path:"/home/games",
              ico:"/static/t111/img/slot-game1.png",
              name:"彩票游戏",
              text:"主流玩法精彩加奖"
            },
          ...
          rightData:[
            {
              path:"",
              ico:"/static/t111/img/live-game.png",
              name:"棋牌游戏",
              text:"休闲益智  棋乐无穷"
            },
            {
              path:"",
              ico:"/static/t111/img/sport-game.png",
              name:"真人视讯",
              text:"美女主播  热火传情"
            },
          ],
          lastData:[
            {
              path:"",
              ico:"/static/t111/img/lottery-game1.png",
              name:"电子游戏",
              text:"超级大奖池"
            },
            {
              path:"",
              ico:"/static/t111/img/chess-game1.png",
              name:"捕鱼游戏",
              text:"满屏暴金"
            },
            {
              path:"",
              ico:"/static/t111/img/other-game1.png",
              name:"体育电竞",
              text:"丰富赛事 分秒精彩"
            }
          ]
        ...
        advanDatas:[
          {
            icon:"/static/t111/img/tip-demo-1.png",
            name:"立即注册",
            text:"成为澳门新葡京，最尊贵的会员",
            gamename:"tryplay"
          ...
          {
            icon:"/static/t111/img/tip-demo-2.png",
            name:"下载App",
            text:"防劫持，极致体验",
            gamename:"download"
          },
          {
            icon:"/static/t111/img/tip-demo-3.png",
            name:"合作代理",
            text:"携手新葡京，走发财之路",
    ...
    methods: {
      ...
      async advantageClick(advanItem){
        if(advanItem.gamename=='tryplay'){
            ...
            window.open("/static/t111/html/download/index.html")
        }
  ...
  .new-index {
    ...
    .content_bg{
      ...
      .content-main-bg{
        position: relative;
        padding-bottom:10px;
        background:url(/static/t111/img/index-main-bg-1.jpg) no-repeat center top;
          ...
          .game-lists-container{
            ...
            .above-game-content{
              ...
              .slot-game-cont{
                  ...
                  width: 633px;
                  height: 100%;
                  background: url(/static/t111/img/slot-game1.png) no-repeat center top;
                  background-size:100% 100%;   
              ...
              .live-sport-cont{
                ...
                ul{
                  .live-game{
                    ...
                    height: 240px;
                    width: 590px;
                    background: url(/static/t111/img/live-game.png) no-repeat center top;
                    background-size: 100% 100%;
                    right:-2000px;
                    .live-game-context{
                      position: absolute;
                  ...
                  .sport-game{
                    ...
                    height: 210px;
                    width: 680px;
                    background: url(/static/t111/img/sport-game.png) no-repeat center top;
                    background-size: 100% 100%;
                    right:-2000px;
                    .sport-game-context{
                      position: absolute;
            ...
            .below-game-content{
              ...
              .lottery-game{
                  ...
                  height: 219px;
                  width: 470px;
                  background:url(/static/t111/img/lottery-game1.png) no-repeat center top;
                  background-size: 100% 100%;
                  left:-2000px
              }
              .chess-game{
                    ...
                    width: 420px;
                    height: 222px;
                    background: url(/static/t111/img/chess-game1.png) no-repeat center top;
                    background-size: 100% 100%;
                    top:2000px;
                }
              .other-game{
                    ...
                    width: 396px;
                    height: 219px;
                    background: url(/static/t111/img/other-game1.png) no-repeat center top;
                    background-size: 100% 100%;
                    right:-2000px;
                }  
              }
     ...
     .night{
        background:url(/static/t111/img/index-main-bg-n.jpg) no-repeat center top;
        background-size:100% 100%; 
     }
    }
  }
    .vp-popout-box {
      ...
      /deep/ .ivu-modal-header {
        ...
        background: #ff0000 url(/static/t111/img/ui-bg_gloss-wave_45_817865_500x100.png) 50% 50% repeat-x;
        color: #ffffff;
        font-weight: bold;
        position: relative;
        top: 4px;
