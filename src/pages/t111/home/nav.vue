  <template>
    ...
    <!-- <div class="top_nav" :class="{night:colorbool}"> -->
      <div class="nav-content">
        <div class="logo fl">
          <a href="javascript:void(0)" @click="$router.push('/');$parent.getPopout1()">
            <img src="/static/t111/img/qy-logo1.png" style="width:204px;height:61px;">
          </a>
        </div>
        <ul class="nav-bar fl">
          <li
          ...
          >
            <img src="/static/t111/img/thirdparty/hot.gif" class="x-dh-i" alt v-if="item.hotShow">
