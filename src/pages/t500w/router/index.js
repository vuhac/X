...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/t500w/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/t500w/home')), 'vpHome')

const vpYouhui = r => require.ensure([], () => r(require('@/pages/t500w/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/t500w/home/register')), 'register')
const login = r => require.ensure([], () => r(require('@/pages/t500w/home/login')), 'login')
const help = r => require.ensure([], () => r(require('@/pages/t500w/home/help')), 'help')
const moblie = r => require.ensure([], () => r(require('@/pages/t500w/home/moblie')), 'moblie')
const vpCaipiao = r => require.ensure([], () => r(require('@/pages/t500w/home/caipiao')), 'vpCaipiao')
const vpQipai = r => require.ensure([], () => r(require('@/pages/t500w/home/qipai')), 'vpQipai')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/t500w/home/home-contactUs')), 'vpHomeContactUs')
