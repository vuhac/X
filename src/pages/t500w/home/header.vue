      ...
      <div class="container">
        ...
        <h3>
          <router-link to="/home" class="router-link-exact-active curr">
            <img src="../../../../static/t500w/img/home/logo1.png">
          </router-link>
        </h3>
  ...
  .w-header {
    ...
    .menu-child1 {
      ...
      *min-height: 564px;
      ...
      .triangles_back {
        ...
        height: 19px;
        position: absolute;
        background: url(/static/t500w/img/triangles_back.png) no-repeat;
        left: 125px;
        top: -8px;
      }
      ...
      .items {
        ...
        .item {
          ...
          .item-ico {
            ...
            color: #222;
            text-align: center;
            background: url(/static/t500w/img/game-icon-bg.png) no-repeat;
            overflow: hidden;
          ...
          &:hover {
            background: url(/static/t500w/img/Wbg_03.png) repeat;
          }
    ...
    .header-top {
      ...
      .snavInfo {
        ...
        .ServiceBtn {
          background: url("/static/t500w/img/home/service.gif");
