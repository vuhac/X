...
const vpYouhui = r => require.ensure([], () => r(require('@/pages/qygj/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/qygj/home/register')), 'register')
// const register2 = r => require.ensure([], () => r(require('@/pages/qygj/home/register2')), 'register2')
const clause = r => require.ensure([], () => r(require('@/pages/qygj/home/clause')), 'clause')
