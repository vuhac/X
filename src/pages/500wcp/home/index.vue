      ...
      <div class="body">
          ...
          <div class="up">
            <ul>
              <li @click="goto(item.path)" v-for="(item, i) in navData1" :key="i">
                ...
                <span class="other">
                  <a href="javascript: void(0)">{{item.doc}}</a>
                </span>
              </li>
            </ul>
          </div>
        ...
        <div class="center">
          ...
          <div class="down">
            <ol class="tab">
                <li
                  :class="{'tab-item': true, 'active': tabResultIndex === i}"
                ...
                >
                  ...
                  <div class="content" v-if="item.result">
                    <p>
                      第
                      <span>{{item.result.lastissue}}</span>期
                    </p>
        ...
        <div class="right">
          ...
          <div class="center">
            ...
            <div class="down-box">
              ...
              <span class="android" @click="goDownLoad" style="cursor:pointer">
                <span class="fa fa-fw fa-android"></span>
                <span class="name">安卓版</span>
              </span>
              <span class="apple" @click="goDownLoad" style="cursor:pointer">
          ...
          list: [
            {
              ...
              id: "14",
              icon: "/static/500wcp/img/live/icon/AG_LIVE.png"
            },
            {
              name: "BBIN视讯厅",
              platform: "live_casino",
              id: "15",
              icon: "/static/500wcp/img/live/icon/BBIN_LIVE.png"
            },
            {
              name: "BG视讯厅",
              platform: "live_casino",
              id: "44",
              icon: "/static/500wcp/img/live/icon/BG_LIVE.png"
            },
            {
              name: "DG视讯厅",
              platform: "live_casino",
              id: "33",
              icon: "/static/500wcp/img/live/icon/DG_LIVE.png"
            },
            {
              name: "DS视讯厅",
              platform: "live_casino",
              id: "16",
              icon: "/static/500wcp/img/live/icon/DS_LIVE.png"
            },
            {
              name: "LEBO视讯厅",
              platform: "live_casino",
              id: "35",
              icon: "/static/500wcp/img/live/icon/LEBO_LIVE.png"
            },
            {
              name: "OG视讯厅",
              platform: "live_casino",
              id: "39",
              icon: "/static/500wcp/img/live/icon/OG_LIVE.png"
            },
            {
              name: "eBET视讯厅",
              platform: "live_casino",
              id: "34",
              icon: "/static/500wcp/img/live/icon/EBET_LIVE.png"
            },
            {
              name: "LMG视讯厅",
              platform: "live_casino",
              id: "36",
              icon: "/static/500wcp/img/live/icon/LMG_LIVE.png"
            },
            {
              name: "欧博视讯厅",
              platform: "live_casino",
              id: "37",
              icon: "/static/500wcp/img/live/icon/AB_LIVE.png"
            },
            {
              name: "SA视讯厅",
              platform: "live_casino",
              id: "40",
              icon: "/static/500wcp/img/live/icon/SA_LIVE.png"
            }
          ]
        }
      ],
