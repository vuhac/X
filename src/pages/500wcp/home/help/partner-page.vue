  ...
  <div class="body">
    ...
    <div class="content" v-show="index === 0">
      ...
      <p>
        ...
        更改银行帐号的,必须提前一个星期联系在线客服进行修改，否则本公司一律不负责。500万彩票会评估审核联盟申请讯息，3日内由专员与您联系开通，并提供您的注册帐号、密码及推广链接。</p>
    ...
    <div class="content" v-show="index === 1">
      ...
      <ol>
        <li align="left">500万彩票的客服部会登记联盟的会员并会观察他们的投注状况。联盟及会员必须同意并遵守500万彩票的会员条例，政策及操作程序。500万彩票保留拒绝或冻结联盟/会员帐号权利</li>
      ...
      <ol>
        <li align="left">
          各阶层代理联盟不可在未经500万彩票许可情况下开设双/多个的代理帐号，也不可从500万彩票人帐号或相关人士赚取佣金。请谨记任何阶层代理不能用代理帐号下注，500万彩票有权终止并封存帐号及所有在游戏中赚取的佣金。
        </li>
        <li align="left">
          为确保所有500万彩票会员帐号隐私与权益，500万彩票不会提供任何会员密码，或会员个人资料。各阶层代理联盟亦不得以任何方式取得会员数据，或任意登入下层会员帐号，如发现代理联盟有侵害500万彩票会员隐私行为，500万彩票有权取消代理联盟红利，并取消代理联盟帐号。
        </li>
        <li align="left">
          代理联盟旗下的会员不得开设多于一个的帐号。500万彩票有权要求会员提供有效的身份证明以验证会员的身份，并保留以IP判定是否重复会员的权利。如违反上述事项，500万彩票有权终止玩家进行游戏并封存帐号及所有于游戏中赚取的佣金
        </li>
        <li align="left">代理联盟不可为自己或其他联盟下的有效投注会员,只能是公司直属下的有效投注会员,
          代理每月需有5个下线有效投注（有效投注为每周至少上线3次进行正常投注），如有违反联盟协议500万彩票有权终止并封存帐号及所有在游戏中赚取的佣金。
        </li>
        <li align="left">
