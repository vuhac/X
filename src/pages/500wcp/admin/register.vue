    ...
    <div class="popup">
      ...
      <div class="content">
        ...
        <div class="row">
          <label>帐号:</label>
          <div class="group">
            <input type="text" placeholder="帐号（6-10位数字或字母）" maxlength="10" v-model="userName" @blur="getCode">
          </div>
        </div>
        ...
        <div class="row">
          <label>密码:</label>
          <div class="group">
            <input type="password" placeholder="密码（8-20位数字或字母）" maxlength="20" v-model="password">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="group">
            ...
            <input type="password" placeholder="密码（8-20位数字或字母）" maxlength="20" v-model="register_password">
          </div>
        </div>
        ...
        <div class="row" v-if="iscode">
          <label>邀请码:</label>
          <div class="group">
            <input type="text" placeholder="邀请码" maxlength="6" v-model="intacode" :readonly="incodeReadonly">
          </div>
        </div>
