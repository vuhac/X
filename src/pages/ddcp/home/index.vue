        ...
        <div class="autoTab clearfix">
          <div class="left fl">
            <ul class="hd clearfloat">
              <!-- <li :class="{on:hdActive==0}" @click="getResult({name:'bjsc',id:2});hdActive=0">快速快三</li> -->
              <li :class="{on:hdActive==0}" @click="getResult({name:'ksk3',id:27});hdActive=0">快速快三</li>
              ...
              <li :class="{on:hdActive==4}" @click="getResult({name:'bjsc',id:2});hdActive=4">北京赛车</li>
            </ul>
  ...
  export default {
    ...
    data () {
      return {
        showimg:false,
        showPopout: false,
        imgsrc:'/static/ddcp/img/qpssq.png',
        popups: '',
        lantern: '',
        isCode: 'ios',
        active: 0,
      ...
      async getResult (item) {
        ...
        if (res && res.code == 200) {
          ...
          if (target) {
            ...
            this.allReData.img=`/static/public/image/lottery/nico/png/${target.id}.png`
