...
const vpYouhui = r => require.ensure([], () => r(require('@/pages/xpj/home/youhui/index1.vue')), 'vpYouhui')
...
// const TotalMosaic = r => require.ensure([], () => r(require('@/pages/xpj/home/youhui/totalmosaic.vue')), 'TotalMosaic')
...
const clause = r => require.ensure([], () => r(require('@/pages/xpj/home/clause')), 'clause')
const agent = r => require.ensure([], () => r(require('@/pages/xpj/home/agent')), 'agent')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/xpj/home/home-contactUs')), 'vpHomeContactUs')
