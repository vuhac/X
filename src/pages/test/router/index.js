...
const vpYouhui = r => require.ensure([], () => r(require('@/pages/test/home/youhui/index1')), 'vpYouhui')
...
const register2 = r => require.ensure([], () => r(require('@/pages/test/home/register2')), 'register2')
const clause = r => require.ensure([], () => r(require('@/pages/test/home/clause')), 'clause')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/test/home/help/About/index')), 'about')
const contact = r => require.ensure([], () => r(require('@/pages/test/home/help/contact')), 'contact')
const savings = r => require.ensure([], () => r(require('@/pages/test/home/help/Savings/index')), 'savings')
const issue = r => require.ensure([], () => r(require('@/pages/test/home/help/issue')), 'issue')
const partner = r => require.ensure([], () => r(require('@/pages/test/home/help/partner')), 'partner')
const help_withdrawals = r => require.ensure([], () => r(require('@/pages/test/home/help/help-Withdrawals')), 'help_withdrawals')
