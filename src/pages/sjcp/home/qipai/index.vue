    ...
    <div class="wrapper">
      ...
      <ul>
        <li v-for="(item,i) in buyuData" :key="i">
          ...
          <p><a class="btn_ag" @click="trustLogin({platform:item.platform,gameName:item.gameName,name:item.name,id:item.id})" href="javascript:void(0)">游戏说明</a>
          </p>
        </li>
    ...
    data () {
      return {
        buyuData: [
          ...
          {
            name: '开元棋牌',
            img: '/static/sjcp/img/chess2.png',
            content: '经典玩法 玩法丰富',
            platform: 'KY_CHESS',
            gameName: '0',
            id:243
          ...
          {
            name: 'VG棋牌',
            img: '/static/sjcp/img/chess3.png',
            content: '经典玩法 玩法丰富',
            platform: 'VG_CHESS',
            gameName: '1000',
            id:10091
...
<style lang="less" scoped>
  .fishing_main {
    ...
    height: 900px;
    background: url("/static/sjcp/img/chess_bg.jpg") center top;
