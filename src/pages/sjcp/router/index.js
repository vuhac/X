...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/sjcp/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/sjcp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/sjcp/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/sjcp/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/sjcp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/sjcp/home/youhui/index.vue')), 'vpYouhui')
const vpQipai = r => require.ensure([], () => r(require('@/pages/sjcp/home/qipai')), 'vpQipai')

const TotalMosaic = r => require.ensure([], () => r(require('@/pages/sjcp/home/youhui/totalmosaic.vue')), 'TotalMosaic')

const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const register = r => require.ensure([], () => r(require('@/pages/sjcp/home/register')), 'register')
const clause = r => require.ensure([], () => r(require('@/pages/sjcp/home/clause')), 'clause')

// 帮助
const vpHomeContactUs = r => require.ensure([], () => r(require('@/pages/sjcp/home/home-contactUs')), 'vpHomeContactUs')

const about = r => require.ensure([], () => r(require('@/pages/sjcp/home/help/About/index')), 'about')

// 代理教程
const agent = r => require.ensure([], () => r(require('@/pages/sjcp/home/agent')), 'agent')
