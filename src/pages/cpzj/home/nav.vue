        ...
        navlist1: [
          ...
          },
          {
            name: '真人视讯', link: '/home/live', hot: true, en: 'CASINO', sub: [
              {name: 'AG视讯厅', platform: 'live_casino', id: '31', icon: '/static/cpzj/img/live/icon/AG_LIVE.png'},
              {name: 'BBIN视讯厅', platform: 'live_casino', id: '32', icon: '/static/cpzj/img/live/icon/BBIN_LIVE.png'},
              {name: 'BG视讯厅', platform: 'live_casino', id: '3180', icon: '/static/cpzj/img/live/icon/BG_LIVE.png'},
              {name: 'DG视讯厅', platform: 'live_casino', id: '42', icon: '/static/cpzj/img/live/icon/DG_LIVE.png'},
              {name: 'DS视讯厅', platform: 'live_casino', id: '34', icon: '/static/cpzj/img/live/icon/DS_LIVE.png'},
              {name: 'LEBO视讯厅', platform: 'live_casino', id: '44', icon: '/static/cpzj/img/live/icon/LEBO_LIVE.png'},
              {name: 'OG视讯厅', platform: 'live_casino', id: '48', icon: '/static/cpzj/img/live/icon/OG_LIVE.png'},
              {name: 'eBET视讯厅', platform: 'live_casino', id: '43', icon: '/static/cpzj/img/live/icon/EBET_LIVE.png'},
              {name: 'LMG视讯厅', platform: 'live_casino', id: '45', icon: '/static/cpzj/img/live/icon/LMG_LIVE.png'},
              {name: '欧博视讯厅', platform: 'live_casino', id: '46', icon: '/static/cpzj/img/live/icon/AB_LIVE.png'},
              {name: 'SA视讯厅', platform: 'live_casino', id: '49', icon: '/static/cpzj/img/live/icon/SA_LIVE.png'}
            ]
          },
