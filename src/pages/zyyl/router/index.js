...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/zyyl/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/zyyl/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/zyyl/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/zyyl/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/zyyl/home/buyu')), 'vpBuyu')
const vpTiyu = r => require.ensure([], () =>r(require('@/pages/zyyl/home/tiyu')),'vpTiyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/zyyl/home/youhui/index1')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const vpQipai = r => require.ensure([], () => r(require('@/pages/zyyl/home/qipai')), 'vpQipai')

const register = r => require.ensure([], () => r(require('@/pages/zyyl/home/register')), 'register')
// const register2 = r => require.ensure([], () => r(require('@/pages/zyyl/home/register2')), 'register2')
const clause = r => require.ensure([], () => r(require('@/pages/zyyl/home/clause')), 'clause')

// 帮助
const about = r => require.ensure([], () => r(require('@/pages/zyyl/home/help/About/index')), 'about')
const contact = r => require.ensure([], () => r(require('@/pages/zyyl/home/help/contact')), 'contact')
const savings = r => require.ensure([], () => r(require('@/pages/zyyl/home/help/Savings/index')), 'savings')
const issue = r => require.ensure([], () => r(require('@/pages/zyyl/home/help/issue')), 'issue')
const partner = r => require.ensure([], () => r(require('@/pages/zyyl/home/help/partner')), 'partner')
const help_withdrawals = r => require.ensure([], () => r(require('@/pages/zyyl/home/help/help-Withdrawals')), 'help_withdrawals')
