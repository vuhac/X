    ...
    <div class="popup">
      ...
      <div class="content">
        ...
        <div class="row">
          <label>帐号:</label>
          <div class="group">
            <input type="text" placeholder="帐号（6-10位数字或字母）" maxlength="20" v-model="userName" @blur="getCode">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="group">
            ...
            <input type="password" placeholder="密码（6-20位数字或字母）" maxlength="20" v-model="register_password">
          </div>
        </div>
  ...
  .register {
    ...
    .popup {
      ...
      .headline {
        ...
        background: url("/static/wycp/img/bg_reg_title.png");
