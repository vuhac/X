<template>
  <div class="footer-main">
    <ul class="footer-child footer-nav clear-fix">
      <li class="nav-item">
        <div
          style="width: 202px;height: 47px;background: url('/static/wycp/img/bottom_wy.png') no-repeat 0 0;background-size: 202px 47px;"></div>
        <div class="head-foot"
    ...
    <div class="footer-child other">
      网易彩票版权所有 ©2008-2020
      <br/>
      网易彩票提醒您：理性购彩，热心公益。未满18周岁的未成年人禁止购彩及兑奖！
    </div>
  ...
  .footer-main {
    ...
    .footer-nav {
      ...
      .nav-item {
        ...
        .head-foot {
          background: url("/static/wycp/img/headfoot.png") no-repeat;
        }
    ...
    .images {
      ...
      .footer-img {
        ...
        margin: 0 10px;
        float: left;
        background: url("/static/wycp/img/footer_img.png") no-repeat;
      }
    }
