      ...
      <li v-for="(item,i) in navlist1" :class="{'nav-active': navActive === i}" :key="i">
        ...
        <ol class="nav-children clear-fix" v-if="item.sub">
          <li v-for="(child, index) in item.sub" :key="index" @click.stop="goThirdParty(child)">
            ...
            <p>{{child.name}}</p>
            <img v-if="child.hot" class="hot" src="/static/wycp/img/hot.gif">
          </li>
        </ol>
      </li>
    </ul>
         ...
         navlist1: [
          ...
          },
          {
            name: '真人视讯', link: '/home/live', en: 'CASINO', sub: [
              {name: 'AG视讯厅', platform: 'live_casino', id: '31', icon: '/static/wycp/img/live/icon/AG_LIVE.png'},
              {name: 'BBIN视讯厅', platform: 'live_casino', id: '32', icon: '/static/wycp/img/live/icon/BBIN_LIVE.png'},
              {name: 'BG视讯厅', platform: 'live_casino', id: '3180', icon: '/static/wycp/img/live/icon/BG_LIVE.png'},
              {name: 'DG视讯厅', platform: 'live_casino', id: '42', icon: '/static/wycp/img/live/icon/DG_LIVE.png'},
              {name: 'DS视讯厅', platform: 'live_casino', id: '34', icon: '/static/wycp/img/live/icon/DS_LIVE.png'},
              {name: 'LEBO视讯厅', platform: 'live_casino', id: '44', icon: '/static/wycp/img/live/icon/LEBO_LIVE.png'},
              {name: 'OG视讯厅', platform: 'live_casino', id: '48', icon: '/static/wycp/img/live/icon/OG_LIVE.png'},
              {name: 'eBET视讯厅', platform: 'live_casino', id: '43', icon: '/static/wycp/img/live/icon/EBET_LIVE.png'},
              {name: 'LMG视讯厅', platform: 'live_casino', id: '45', icon: '/static/wycp/img/live/icon/LMG_LIVE.png'},
              {name: '欧博视讯厅', platform: 'live_casino', id: '46', icon: '/static/wycp/img/live/icon/AB_LIVE.png'},
              {name: 'SA视讯厅', platform: 'live_casino', id: '49', icon: '/static/wycp/img/live/icon/SA_LIVE.png'}
            ]
          },
            ...
            name: '体育赛事', link: '/home/tiyu', en: 'SPORT', sub: [
              {
                ...
                path: '/home/tiyu',
                id: '39',
                icon: '/static/wycp/img/home/tiyu-icon/SX_SPORT.png'
              },
              {
                name: '沙巴体育',
                path: '/home/tiyu',
                id: '38',
                icon: '/static/wycp/img/home/tiyu-icon/SB_SPORT.png'
              },
              {
                name: 'BBIN体育',
                path: '/home/tiyu',
                id: '41',
                icon: '/static/wycp/img/home/tiyu-icon/BBIN_SPORT.png'
              },
              {
                name: 'AG体育',
                path: '/home/tiyu',
                id: '40',
                icon: '/static/wycp/img/home/tiyu-icon/AG_SPORT.png'
              }
            ]
          },
          {name: '电子游艺', link: '/home/games?id=10022&name=MG老虎机', hot: true,  en: 'GAME'},
    ...
    .nav-main {
      ...
      > li {
        ...
        .hot {
          ...
          width: 20px;
          height: 14px;
          background: url("/static/wycp/img/hot_new.gif") no-repeat;
        }
        ...
        .nav-children {
          ...
          > li {
            ...
            > div {
              ...
              height: 80px;
              margin: 0 auto;
              background-image: url("/static/wycp/img/game-icon-bg.png");
