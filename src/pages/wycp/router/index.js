...
const vpRegister = r => require.ensure([], () => r(require('@/pages/wycp/home/register')), 'vpRegister')
...
const vpQipai = r => require.ensure([], () => r(require('@/pages/wycp/home/qipai')), 'vpQipai')
const vpTiyu = r => require.ensure([], () => r(require('@/pages/wycp/home/tiyu')), 'vpTiyu')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
const vpIssue = r => require.ensure([], () => r(require('@/pages/wycp/home/issue')), 'vpIssue')
const vpDuty = r => require.ensure([], () => r(require('@/pages/wycp/home/duty')), 'vpDuty')
const vpSaveHelp = r => require.ensure([], () => r(require('@/pages/wycp/home/help/save-help')), 'vpSaveHelp')
const vpPullHelp = r => require.ensure([], () => r(require('@/pages/wycp/home/help/pull-help')), 'vpPullHelp')
const vpRelation = r => require.ensure([], () => r(require('@/pages/wycp/home/help/relation')), 'vpRelation')
const vpAboutPage = r => require.ensure([], () => r(require('@/pages/wycp/home/help/about-page')), 'vpAboutPage')
const vpPartnerPage = r => require.ensure([], () => r(require('@/pages/wycp/home/help/partner-page')), 'vpPartnerPage')
const clause = r => require.ensure([], () => r(require('@/pages/wycp/home/clause')), 'clause')
