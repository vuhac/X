<template>
  <div class="new-home">
          ...
          <!-- <div class="appCode fr">
            ...
            <div class="wrapper">
              <div v-show="isCode=='ios'" class="ios">
                <img src="/static/jlcp/img/ios.png" alt="">
              </div>
              <div v-show="isCode=='android'" class="android">
                <img src="/static/jlcp/img/android.png" alt="">
              </div>
            </div>
          </div> -->
        </div>
        <div class="news">
          <div class="newsContent">
            <div class="demolist list" style="height:35px;">
              <div class="notice">
                <img src="/static/jlcp/img/icon_notice.png" alt="">
              </div>
    ...
    <Modal :scrollable=true title="网站公告" ok-text="关闭" v-model="showPopout" width="657" class="vp-popout-box">
      ...
      <Modal width="657" height="546.67" :scrollable=true v-model="showimg" class='guanbi'><img width="100%" height="100%" src="/static/jlcp/img/pcAlert.png"/><span class="close" @click="close"></span></Modal>
  </div>
</template>
    ...
    data () {
      return {
        ...
        lives: [
          {
            name: '购彩大厅',
            src: '/static/jlcp/img/nhome/game2.png',
            // id: 14,
            path:"/plays/hall",
          ...
          {
            name: '棋牌游戏',
            src: '/static/jlcp/img/nhome/game3.png',
            path:"/home/qipai",
            // id: 15,
            // platform: 'live_casino'
          },
          ...
          {
            name: '捕鱼达人',
            src: '/static/jlcp/img/nhome/game1.png',
            path:"/home/buyu",
            // id: 16,
            // platform: 'live_casino'
          }
        ...
        random: [
          {
            account: '',
            name: '江苏快3',
            ico: '/static/jlcp/img/home/slder1.jpg',
            out: 0
          },
          {
            account: '',
            name: '湖北快3',
            ico: '/static/jlcp/img/home/slder.jpg',
            out: 0
          },
          {
            account: '',
            name: '5分六合',
            ico: '/static/jlcp/img/home/slder2.jpg',
            out: 0
          },
          {
            account: '',
            name: '极速赛车',
            ico: '/static/jlcp/img/home/slder3.jpg',
            out: 0
          },
          {
            account: '',
            name: '北京赛车',
            ico: '/static/jlcp/img/home/slder4.jpg',
            out: 0
          },
          {
            account: '',
            name: '快速11选5',
            ico: '/static/jlcp/img/home/slder5.jpg',
            out: 0
          },
          {
            account: '',
            name: '幸运飞艇',
            ico: '/static/jlcp/img/home/td1.jpg',
            out: 0
          },
          {
            account: '',
            name: '重庆时时彩',
            ico: '/static/jlcp/img/home/slder6.jpg',
            out: 0
          },
          {
            account: '',
            name: '幸运农场',
            ico: '/static/jlcp/img/home/slder7.jpg',
            out: 0
          },
          {
            account: '',
            name: '广东快乐十分',
            ico: '/static/jlcp/img/home/slder8.jpg',
            out: 0
          }
        ],
        questions: [
...
<style lang="less" scoped>
  @import "../../../assets/less/jlcp/flipclock.css";
  ...
  .new-home {
    padding-bottom: 10px;
    background-image: url(/static/jlcp/img/home_bj.png);
    ...
    .container {
      ...
      .wrapR {
          ...
          .right {
            ...
            .img {
              ...
              i {
                ...
                background: url(/static/jlcp/img/icon/home.fw.png) no-repeat -142px
                6px;
              }
            ...
            .rule {
              ...
              i {
                ...
                width: 32px;
                height: 32px;
                background: url(/static/jlcp/img/icon/home.fw.png) no-repeat;
                line-height: 32px;
                color: #cc0000;
                vertical-align: middle;
              }
        ...
        .lives {
          ...
          margin-top: 10px;
          // padding: 11px 0;
          background: url(/static/jlcp/img/livebg.png) repeat;
          ...
          .wrapper {
            ...
            .liveItem {
              ...
              span {
                ...
                padding: 13px 58px;
                display: none;
                background: url(/static/jlcp/img/livebtn-enter.png) no-repeat;
              }
