        ...
        <div class="linkbar clearfix">
          ...
          <div class="link fr">
            <ul class="clearfix">
              ...
              <li><a :class="className1" href="/static/jlcp/html/download/index.html" target="_blank">APP下载</a></li>
        ...
        <div class="loginBox">
          ...
          <h3 class="logo">
            <router-link to="/home" class="router-link-exact-active curr" style="display:inline-block;margin-left:-25px;">
              <img src="/static/jlcp/img/nhome/logo.png" style="margin-top:-7px;">
            </router-link>
            <img src="/static/jlcp/img/nhome/biaoti.png" alt="" class="textPic" style="margin-right:-33px;">
            <!--<img src="/static/jlcp/img/slogan.png">-->
          </h3>
          <div class="user">
            <!-- 登录前 -->
  ...
  export default {
    ...
    data () {
      return {
        navActive:0,
        passKey: {},
        codeImg: '/static/jlcp/img/code.jpg',
        balanceShow: false,
      ...
      .loginBox {
        ...
        .user {
          ...
          .snavInfo {
            ...
            .ServiceBtn {
              background: url("/static/jlcp/img/home/service.gif");
      ...
      ul {
        ...
        li {
          ...
          .hot {
            ...
            width: 20px;
            height: 14px;
            background-image: url("/static/jlcp/img/icon/hot.gif");
          }
