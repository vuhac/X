...
//默认空首页
const index = r => require.ensure([], () => r(require('@/pages/jlcp/index.vue')), 'index')
// 新首页
const vpHome = r => require.ensure([], () => r(require('@/pages/jlcp/home')), 'vpHome')

const vpHomeLive = r => require.ensure([], () => r(require('@/pages/jlcp/home/home-live')), 'vpHomeLive')
const vpGames = r => require.ensure([], () => r(require('@/pages/jlcp/home/games')), 'vpGames')
const vpBuyu = r => require.ensure([], () => r(require('@/pages/jlcp/home/buyu')), 'vpBuyu')
const vpYouhui = r => require.ensure([], () => r(require('@/pages/jlcp/home/youhui')), 'vpYouhui')
const vpLoading = r => require.ensure([], () => r(require('@/pages/public/games/loading')), 'vpLoading')
// const register = r => require.ensure([], () => r(require('@/pages/jlcp/home/register')), 'register')
const help = r => require.ensure([], () => r(require('@/pages/jlcp/home/help/index.vue')), 'help')
const question = r => require.ensure([], () => r(require('@/pages/jlcp/home/help/question.vue')), 'question')
const vpQipai = r => require.ensure([], () => r(require('@/pages/jlcp/home/qipai')), 'vpQipai')
const vpSport = r => require.ensure([], () => r(require('@/pages/jlcp/home/sport')), 'vpSport')
const contactUs = r => require.ensure([], () => r(require('@/pages/jlcp/home/contactUs')), 'contactUs')
const clause = r => require.ensure([], () => r(require('@/pages/jlcp/home/clause')), 'clause')
