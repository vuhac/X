...
<div>
  ...
  <!--<div class="new2019 animated fadeInUp mobile_auto" onclick="window.open('/static/klk/html/active/pig2019/#')" v-if="showNew2019">
...
<style lang="less" scoped>
  ...
  .new2019{
    ...
    width: 230px;
    height: 230px;
    background-image: url('/static/klk/img/new2019.gif');

    .clBtn{
      background: url('/static/klk/img/new2019_close.png'); 
      z-index: 99999; 
      position: absolute; 
      width: 23px;
      height: 23px; 
