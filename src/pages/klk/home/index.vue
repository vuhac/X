<template>
  <div class="new-index klk-home">
      ...
      <div class="game-list-right">
            ...
            >
              <Carousel-item>
                <ul class="item_list">
                  <li
                    class="item"
                    @click="getItemId({name:'OG视讯厅',id:'39',platform:'live_casino'})"
                  >
                  ...
                  <li
                    class="item"
                    @click="getItemId({name:'eBET视讯厅',id:'34',platform:'live_casino'})"
                  >
                  ...
                  <li
                    class="item loy"
                    @click="getItemId({name:'LMG视讯厅',id:'36',platform:'live_casino'})"
                  >
                  ...
                  <li
                    class="item"
                    @click="getItemId({name:'欧博视讯厅',id:'37',platform:'live_casino'})"
                  >
                  ...
                  <li
                    class="item"
                    @click="getItemId({name:'SA视讯厅',id:'40',platform:'live_casino'})"
                  >
              ...
              <Carousel-item>
                <ul class="item_list">
                  ...
                  <li
                    class="item"
                    @click="getItemId({name:'BBIN视讯',id:'15',platform:'live_casino'})"
                  >
                    <div class="ball">BBIN</div>
                  ...
                  <li
                    class="item loy"
                    @click="getItemId({name:'BG视讯',id:'44',platform:'live_casino'})"
                  >
                  ...
                  <li
                    class="item"
                    @click="getItemId({name:'LEBO视讯',id:'35',platform:'live_casino'})"
                  >
        ...
        <div class="fish_game game-bg">
          <ul class="item_list">
            ...
            <li
              class="item"
              @click="trustLogin({name:'深海大赢家',platform:'PT_GAME',gameName:'cashfi',id:2628})"
            >
              <div class="ball">PT</div>
            ...
            <li
              class="item"
              @click="trustLogin({name:'龙王捕鱼',platform:'JDB_GAME',gameName:'7#7002',id:175})"
            >
              <div class="ball">JDB</div>
    ...
    <!-- <Modal :scrollable="true" v-model="showPopout" width="892" class="vp-popout-box">
      <div slot="header" class="header"></div>
      <div class="popout-box">
        <ul class="popout-box-left">
          <li
            @click="goLink(asideIndex)"
            :class="{'active':checkedIndex==asideIndex}"
            v-for="(asideItem,asideIndex) in aisedList"
            :key="asideIndex"
          >
            <div class="box-left">
              <span>{{asideIndex}}</span>
            </div>
            <div class="box-right">
              <p>{{asideItem.name}}</p>
              <p>{{asideItem.time}}</p>
        ...
        <div class="popout-box-right">
          <div
            v-for="(conItem,conIndex) in aisedList"
            :key="conIndex"
            v-show="checkedIndex==conIndex"
          >{{conItem.content}}</div>
        </div>
      </div>
      <div slot="footer" class="footer">
        <Button type="primary" size="large" @click="showPopout = false">我知道了</Button>
      </div>
    </Modal> -->
    <!-- <Modal
      width="907"
