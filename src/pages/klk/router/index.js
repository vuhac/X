...
const vpYouhui = r => require.ensure([], () => r(require('@/pages/klk/home/youhui/index1')), 'vpYouhui')
...
// const register2 = r => require.ensure([], () => r(require('@/pages/klk/home/register2')), 'register2')
