<template>
  <div class="clause">
    <div class="content">
      <div class="logo">
        <img src="/static/jltx/img/dianzi/logo.png" style="height:100%;">
      </div>
      <div class="rulesBody">
        ...
        <div class="toggle">
          <span class="title-style3"><a href="javascript:void(0)" @click="chang_rule('rule_all');">通则</a></span>
          <span class="title-style3"><a href="javascript:void(0)" @click="chang_rule('rule_ipl');">线上娱乐城</a></span>
          <span class="title-style3"><a href="javascript:void(0)" @click="chang_rule('rule_ball');">运动投注</a></span>
          <span class="title-style3"><a href="javascript:void(0)" @click="chang_rule('rule_other');">其他游戏</a></span>
        </div>
        <component :is="component"></component>
      </div>
      <div class="footer">Copyright &copy; 广东会 Reserved</div>
    </div>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
       getHeight(){
        let oHeight=window.screen.availHeight;
        console.log(oHeight);
        let oDiv=document.getElementsByClassName('clause')[0]
        oDiv.style.minHeight=oHeight+'px';
      },
      chang_rule (target) {
