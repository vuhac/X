      ...
      <div class="content">
        <div class="title_tab">
          ...
          <div class="close1" @click="close">
            <img src="/static/jltx/img/register/close_ico.png" alt="">
          </div>
        </div>
        ...
        <div class="row">
          <label>密码:</label>
          <div class="group">
            <input :type="pwdInp" ref="pwdInp" placeholder="请输入8到20位的数字或字母组合" maxlength="20" v-model="password">
            <img @click='changType' class='eys_ico1' src="/static/jltx/img/register/eyes_ico.png" alt="">
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      submitRegister () {
        ...
        // 如果注册表里面register中存在属性和值，将其取出，赋给params
        //  console.log(params);
         if (this.agent) {
      ...
      close () {
        this.$store.commit('jltx/showRegister', false)
      },
      //修改密码框type类型
      changType(){
    ...
    computed: {
      isResiter () {
        return this.$store.state.jltx.registerShow
      }
    },
    store
  }
  ...
  .register {
    ...
    .popup {
      ...
      .headline {
        ...
        background: url("/static/jltx/img/register/header_log.png");
