  ...
  <div>
    <div class="vp-hsyl-style" :class="{'tcgBlur':$store.state.personal.isPersonal}">
      ...
      <div v-else class="hsyl-cont-wrap">
        ...
        <vp-nav></vp-nav>
        <div v-if="
          $route.path.includes('/home/live')||
          $route.path.includes('/home/games')||
          $route.path.includes('/home/buyu')||
          $route.path.includes('/home/youhui')
        ">
          <vp-notice></vp-notice>
        </div>
        <!-- <vp-aside></vp-aside> -->
  ...
  export default {
    data () {
      return {
        ...
        lotHeadDatas: {
          logoUrl: '/static/jltx/img/dianzi/logo2.png',
